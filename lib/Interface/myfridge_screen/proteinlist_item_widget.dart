...
class ProteinlistItemWidget extends StatefulWidget {
  ...
  @override
  _ProteinlistItemWidgetState createState() => _ProteinlistItemWidgetState();
}

class _ProteinlistItemWidgetState extends State<ProteinlistItemWidget> {
